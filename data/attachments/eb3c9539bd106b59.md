...
- Name: authentication/logout.spec.js >> Authentication - Logout Tests >> TC08 Verify Restricted Page Access After Logout
- Location: tests/authentication/logout.spec.js:43:2
            ...
            - generic [ref=e92]:
              ...
              - generic [ref=e96]:
                ...
                - generic [ref=e101]:
                  ...
                  - textbox "Email:" [active] [ref=e103]: testuser@example.com
                - generic [ref=e104]:
...
```ts
  ...
  12 | 
  13 |         this.rememberMe = page.locator('#RememberMe');
  14 | 
  15 |         this.loginButton = page.locator('input[value="Log in"]');
  16 | 
  17 |         this.logoutLink = page.locator('.ico-logout');
  18 | 
  19 |         this.errorMessage = page.locator('.validation-summary-errors');
  20 | 
  21 |         this.accountName = page.locator('.account');
  22 |     }
  23 | 
  24 | 
  25 |     async gotoLoginPage() {
  26 | 
  27 |         await this.page.goto('https://demowebshop.tricentis.com/');
  28 | 
  29 |         await this.loginLink.click();
  30 |     }
  31 | 
  32 | 
  33 |     async login(email, password) {
  34 | 
  ...
  40 |         this.page.waitForLoadState('networkidle'),
  41 |         this.loginButton.click()
  42 |     ])
  43 |     }
  44 | 
  45 | 
  46 |     async loginWithRememberMe(email, password) {
  47 | 
  48 |         await this.emailInput.fill(email);
  49 | 
  50 |         await this.passwordInput.fill(password);
  51 | 
  52 |         await this.rememberMe.check();
  53 | 
...
> 60 |         await this.logoutLink.click();
  ...
  62 | 
  63 | 
  64 |     async getErrorText() {
  65 | 
  66 |         return await this.errorMessage.textContent();
  67 |     }
  68 | }
  69 | 
